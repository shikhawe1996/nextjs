        ...
        <div className="container">
         <div className="col-wrap flex gap-4 items-center xxs:max-md:w-full xxs:max-md:flex-col">
            ...
            <div className="content-wrap w-[50%] xxs:max-md:w-full">
                ...
                <p className='text-lg text-darkGray mt-[8px] max-w-lg'>Join a fun, hands-on cooking experience where you are never alone in the kitchen. Cook with us and follow step-by-step instructions guided by expert chefs who make every recipe easy and enjoyable. Whether you are mastering a classic dish or trying something new, you wll feel like you are cooking side by side with a pro. Cooking together with the expert means gaining confidence, learning techniques, and creating delicious meals—all from your own home. Lets turn your kitchen into a place of learning, creativity, and great taste!</p>
